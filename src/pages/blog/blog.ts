...
import { AlertController, IonicPage, App, FabContainer, ItemSliding, List, NavParams, 
ModalController, NavController, ToastController, LoadingController, Refresher } from 'ionic-angular';
...
export class BlogPage {
  ...
  constructor(
    public alertCtrl: AlertController,public app: App,public loadingCtrl: LoadingController,public modalCtrl: ModalController,
    public navCtrl: NavController,public toastCtrl: ToastController,public service: Service,
    ...
    this.service.getCategoryPost(this.id = 107, this.page)
